...
const RegisterScreen = ({ navigation }) => {
    ...
    function regularFormInput(placeholder) {
        return (
            <View style={{
            ...
            >
                ...
                >
                    <ScrollView style={{ paddingBottom: Sizes.fixPadding * 2.0 }}>
                        ...
                        <Text style={{ ...Fonts.white16Regular, marginTop: Sizes.fixPadding }}>Create an account</Text>
                        {regularFormInput('First Name')}
                        {regularFormInput('Last Name')}
                        {email()}
                        {regularFormInput('Phone Number')}
                        {password()}
                        {confirmPassword()}
                        {registerButton()}
                    </ScrollView>
